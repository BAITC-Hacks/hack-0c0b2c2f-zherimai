...
class Element{
 constructor(tag='div'){this.tagName=tag;this.childNodes=[];this.style={};this.value='';this.listeners={};this.classList={toggle(){}};this._text='';}
